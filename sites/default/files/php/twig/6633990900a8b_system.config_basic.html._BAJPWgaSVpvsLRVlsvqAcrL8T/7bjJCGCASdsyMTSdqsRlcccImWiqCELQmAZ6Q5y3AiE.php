...
class __TwigTemplate_febd034bc773ed4de1518e2cd2e60deb extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "/var/www/html/drupal/tuto/core/modules/system/help_topics/system.config_basic.html.twig");
    }
